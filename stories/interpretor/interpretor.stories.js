...
const styleDecorator = storyFn => <div style={{ marginTop: "5%" }}>{storyFn()}</div>;
...
stories.add("Parenthesis", () => <Interpretor expression="(10 + 2) * 123456" />);

// Arithmetic

storiesOf("Interpretor/Arithmetic", module).add("Div", () => <Interpretor expression="3 / 2" />);
storiesOf("Interpretor/Arithmetic", module).add("Mul", () => <Interpretor expression="11 * 27" />);
storiesOf("Interpretor/Arithmetic", module).add("Minus", () => <Interpretor expression="1 - 2" />);
storiesOf("Interpretor/Arithmetic", module).add("Plus", () => <Interpretor expression="10 + 2" />);
...
// Comparison
storiesOf("Interpretor/Comparison", module).add("Equal to", () => <Interpretor expression="100 = 1" />);
const ELEMENTS = {
    dataStructure: { col_1: {} },
...
storiesOf("Interpretor/Comparison", module).add("Less than", () => <Interpretor expression="100 < 1" />);
storiesOf("Interpretor/Comparison", module).add("Less than or equal to", () => (
    <Interpretor expression="100 <= 100" />
));
storiesOf("Interpretor/Comparison", module).add("More than", () => <Interpretor expression="100 > 1" />);
...
storiesOf("Interpretor/Comparison/Dates", module).add("Less than or equal to", () => (
    <Interpretor expression='cast("2020-01-01", date, "YYYY-MM-DD") <= cast("2020-01-02", date, "YYYY-MM-DD")' />
));
storiesOf("Interpretor/Comparison/Dates", module).add("More than", () => (
    <Interpretor expression='cast("2020-01-01", date, "YYYY-MM-DD") > cast("2020-01-02", date, "YYYY-MM-DD")' />
));
storiesOf("Interpretor/Comparison/Dates", module).add("More than or equal to", () => (
    <Interpretor expression='cast("2020-01-01", date, "YYYY-MM-DD") >= cast("2020-01-02", date, "YYYY-MM-DD")' />
));
...
storiesOf("Interpretor/Conditional", module).add("Nvl", () => <Interpretor expression="nvl(null, 5)" />);
...
storiesOf("Interpretor/Boolean algebra", module).add("Not", () => <Interpretor expression="not true" />);
...
storiesOf("Interpretor/Function/Cast", module).add("Into time", () => <div>TODO</div>);
storiesOf("Interpretor/Function/Cast", module).add("Into date", () => (
    <Interpretor expression='cast("1998-07-12", date, "YYYY-MM-DD")' />
));
storiesOf("Interpretor/Function/Cast", module).add("Into time_period", () => <div>TODO</div>);
storiesOf("Interpretor/Function/Cast", module).add("Into string", () => (
    <Interpretor expression='cast("1998-07-12", string, "YYYY-MM-DD")' />
));
storiesOf("Interpretor/Function/Cast", module).add("Into duration", () => <div>TODO</div>);
const dsI = {
    dataStructure: { col_1: {}, col_2: {} },
    dataPoints: { col_1: ["1", "2", "3"], col_2: ["-1", null] }
};
storiesOf("Interpretor/Function/Cast/Dataset", module).add("Into integer", () => (
...
storiesOf("Interpretor/Function/Cast/Dataset", module).add("Into number", () => (
...
storiesOf("Interpretor/Function/Comparison", module).add("Match characters", () => (
    <Interpretor expression='match_characters("test", "(.*)(es)(.*)?")' bindings={{}} />
));
...
storiesOf("Interpretor/Function/Numeric", module).add("Ln", () => <Interpretor expression="ln(5)" />);
...
storiesOf("Interpretor/Function/Dataset", module).add("Deviation - Sample", () => {
    const ds = {
        dataStructure: {
            col_1: {
                name: "col_1",
...
storiesOf("Interpretor/Function/Dataset", module).add("Deviation - Standard", () => {
    const ds = {
        dataStructure: {
            col_1: {
                name: "col_1",
...
storiesOf("Interpretor/Function/Dataset", module).add("Variance - Sample", () => {
    const ds = {
        dataStructure: {
            col_1: {
                name: "col_1",
...
storiesOf("Interpretor/Function/Dataset", module).add("Variance - Standard", () => {
    const ds = {
        dataStructure: {
            col_1: {
                name: "col_1",

...
[Trevas TS](https://github.com/InseeFr/Trevas-TS) is a TypeScript library for transforming and validating statistical data using the [VTL 2.1](https://sdmx.org/?page_id=5096) language.

...
// Visit a parse tree produced by VtlParser#distanceFunctions.
VtlVisitor.prototype.visitDistanceFunctions = function(ctx) {
  return this.visitChildren(ctx);
};
...
// Visit a parse tree produced by VtlParser#levenshteinAtom.
VtlVisitor.prototype.visitLevenshteinAtom = function(ctx) {
  return this.visitChildren(ctx);
};
...
VtlVisitor.prototype.visitOutputParameterTypeComponent = function(ctx) {
  return this.visitChildren(ctx);
};
...
VtlVisitor.prototype.visitValueDomainValue = function(ctx) {
  return this.visitChildren(ctx);
};

	...
	describe('cast', () => {
		...
		describe('number', () => {
			it('cast number into integer', () => {
				expect(interpret('cast(-10, integer)', {})).toEqual(-10);
				expect(() => interpret('cast(10.5, integer)', {})).toThrow(
					CastTypeError
				);
			});
			...
			it('cast number into time_period', () => {
				expect(() => interpret('cast(10.5, time_period)', {})).toThrow(
					CastTypeError
				);
			});
			...
			it('cast number into duration', () => {
				expect(() => interpret('cast(10.5, duration)', {})).toThrow(
					CastTypeError
				);
			});
		});
		describe('boolean', () => {
			...
			it('cast boolean into time_period', () => {
				expect(() => interpret('cast(true, time_period)', {})).toThrow(
					CastTypeError
				);
			});
		...
		describe('string', () => {
			it('cast string into integer', () => {
				expect(interpret('cast("-10", integer)', {})).toEqual(-10);
				expect(() => interpret('cast("test", integer)', {})).toThrow(
					CastTypeError
				);
			});
			it('cast string into number', () => {
				expect(interpret('cast("10.999", number)', {})).toEqual(10.999);
				expect(() => interpret('cast("test", number)', {})).toThrow(
					CastTypeError
				);
			});
			it('cast string into boolean', () => {
				expect(() => interpret('cast("test", boolean)', {})).toThrow(
					CastTypeError
				);
			});

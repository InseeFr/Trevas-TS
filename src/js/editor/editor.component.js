...
/* */
const createHandlerClickRow = ({ setIndex, setFocusedRow }) => (numberRow, indexInRow) => {
	setIndex(indexInRow);
...
const addRow = (tab = {}, index, start = '', end = '') =>
	tab.reduce((a, o, i) => (i !== index ? [ ...a, o ] : [ ...a, { ...o, value: start }, { value: end } ]), []);

/* */
const removeRow = (tab = [], index, rest) => {
	const result = tab.reduce(
		(a, o, i) => (i === index - 1 ? [ ...a, { ...o, value: `${o.value}${rest}` } ] : i !== index ? [ ...a, o ] : a),
		[]
	);

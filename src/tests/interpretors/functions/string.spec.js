...
describe("string-functions", () => {
    describe("supports string functions with null", () => {
        it("supports substr with null", () => {
            ...
            expect(interpret('substr("abcdefghijklmnopqrstuvwxyz", null, 10)', {})).toBeNull();
            expect(interpret('substr("abcdefghijklmnopqrstuvwxyz", 5, null)', {})).toBeNull();
        });
        ...
        it("supports inst with null", () => {
            ...
            expect(interpret('instr("Hello world", "world", _, null)', {})).toBeNull();
        });
    ...
    it("should substr string", () => {
        expect(interpret('substr("abcdefghijklmnopqrstuvwxyz", 5, 10)', {})).toEqual("efghijklmn");
        expect(interpret('substr("abcdefghijklmnopqrstuvwxyz", 25 , 10) ', {})).toEqual("yz");
        expect(interpret('substr("abcdefghijklmnopqrstuvwxyz", 30, 10) ', {})).toEqual("");
    });
...
describe("upper", () => {
    it("should upper string", () => {
        expect(interpret('upper("AaBbCc 123456789 __")', {})).toEqual("AABBCC 123456789 __");
    });
    it("should fail with type validation", () => {
...
describe("lower", () => {
    it("should lower string", () => {
        expect(interpret('lower("AaBbCc 123456789 __")', {})).toEqual("aabbcc 123456789 __");
    });
    it("should fail with type validation", () => {
...
describe("replace", () => {
    it("should replace string", () => {
        expect(interpret('replace("Hello world", "Hello", "Hi")', {})).toEqual("Hi world");
    });
    it("should replace all occurrences string", () => {
        expect(interpret('replace("Hello Hello world", "Hello", "Hi")', {})).toEqual("Hi Hi world");
    });
    it("should fail with type validation", () => {
        expect(() => interpret('replace(123, "Hello", "Hi")', {})).toThrow(TypeMismatchError);
        expect(() => interpret('replace("Hello world", 123, "Hi")', {})).toThrow(TypeMismatchError);
        expect(() => interpret('replace("Hello world", "Hello", 123)', {})).toThrow(TypeMismatchError);
    });
});
describe("instr", () => {
    it("issue 124", () => {
    ...
    it("should find string after start", () => {
        expect(interpret('instr("Hello world world", "world", 11)', {})).toEqual(13);
    });

    it("should find string occurrence", () => {
        expect(interpret('instr("Hello world world world", "world", _, 2)', {})).toEqual(13);
    });

    it("should find string occurrence with start", () => {
        expect(interpret('instr("Hello world world world", "world", 11, 2)', {})).toEqual(19);
    });

    it("should fail with type validation", () => {
        expect(() => interpret('instr(123, "Hello")', {})).toThrow(TypeMismatchError);
        expect(() => interpret('instr("Hello", 123)', {})).toThrow(TypeMismatchError);
    });
});
